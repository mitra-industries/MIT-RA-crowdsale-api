...
const BasicTokenBin = ``
...
const BurnableTokenBin = ``
...
// DetailedERC20Bin is the compiled bytecode used for deploying new contracts.
const DetailedERC20Bin = `0x`

// DeployDetailedERC20 deploys a new Ethereum contract, binding an instance of DetailedERC20 to it.
func DeployDetailedERC20(auth *bind.TransactOpts, backend bind.ContractBackend, _name string, _symbol string, _decimals uint8) (common.Address, *types.Transaction, *DetailedERC20, error) {
	parsed, err := abi.JSON(strings.NewReader(DetailedERC20ABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(DetailedERC20Bin), backend, _name, _symbol, _decimals)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &DetailedERC20{DetailedERC20Caller: DetailedERC20Caller{contract: contract}, DetailedERC20Transactor: DetailedERC20Transactor{contract: contract}, DetailedERC20Filterer: DetailedERC20Filterer{contract: contract}}, nil
}
...
const OwnableBin = ``
...
const PausableBin = ``
...
const PausableTokenBin = ``
...
const SafeMathBin = `0x604c602c600b82828239805160001a60731460008114601c57601e565bfe5b5030600052607381538281f30073000000000000000000000000000000000000000030146080604052600080fd00a165627a7a72305820bbc0a6875c25cc50399b89751c9a5ede7698d6ed088e83959c361bebac7c42840029`
...
const StandardTokenBin = ``
...
// Mit-raTokenABI is the input ABI used to generate the binding from.
const Mit-raTokenABI = "[{\"constant\":true,\"inputs\":[],\"name\":\"name\",\"outputs\":[{\"name\":\"\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"_spender\",\"type\":\"address\"},{\"name\":\"_value\",\"type\":\"uint256\"}],\"name\":\"approve\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"totalSupply\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"_from\",\"type\":\"address\"},{\"name\":\"_to\",\"type\":\"address\"},{\"name\":\"_value\",\"type\":\"uint256\"}],\"name\":\"transferFrom\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"decimals\",\"outputs\":[{\"name\":\"\",\"type\":\"uint8\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"unpause\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"_value\",\"type\":\"uint256\"}],\"name\":\"burn\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"paused\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"_spender\",\"type\":\"address\"},{\"name\":\"_subtractedValue\",\"type\":\"uint256\"}],\"name\":\"decreaseApproval\",\"outputs\":[{\"name\":\"success\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"_owner\",\"type\":\"address\"}],\"name\":\"balanceOf\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"pause\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"symbol\",\"outputs\":[{\"name\":\"\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"_to\",\"type\":\"address\"},{\"name\":\"_value\",\"type\":\"uint256\"}],\"name\":\"transfer\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"_spender\",\"type\":\"address\"},{\"name\":\"_addedValue\",\"type\":\"uint256\"}],\"name\":\"increaseApproval\",\"outputs\":[{\"name\":\"success\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"_owner\",\"type\":\"address\"},{\"name\":\"_spender\",\"type\":\"address\"}],\"name\":\"allowance\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"name\":\"totalSupply\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[],\"name\":\"Pause\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[],\"name\":\"Unpause\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"name\":\"burner\",\"type\":\"address\"},{\"indexed\":false,\"name\":\"value\",\"type\":\"uint256\"}],\"name\":\"Burn\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"name\":\"owner\",\"type\":\"address\"},{\"indexed\":true,\"name\":\"spender\",\"type\":\"address\"},{\"indexed\":false,\"name\":\"value\",\"type\":\"uint256\"}],\"name\":\"Approval\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"name\":\"from\",\"type\":\"address\"},{\"indexed\":true,\"name\":\"to\",\"type\":\"address\"},{\"indexed\":false,\"name\":\"value\",\"type\":\"uint256\"}],\"name\":\"Transfer\",\"type\":\"event\"}]"

// Mit-raTokenBin is the compiled bytecode used for deploying new contracts.
const Mit-raTokenBin = ``

// DeployMit-raToken deploys a new Ethereum contract, binding an instance of Mit-raToken to it.
func DeployMit-raToken(auth *bind.TransactOpts, backend bind.ContractBackend, totalSupply *big.Int) (common.Address, *types.Transaction, *Mit-raToken, error) {
	parsed, err := abi.JSON(strings.NewReader(Mit-raTokenABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(Mit-raTokenBin), backend, totalSupply)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &Mit-raToken{Mit-raTokenCaller: Mit-raTokenCaller{contract: contract}, Mit-raTokenTransactor: Mit-raTokenTransactor{contract: contract}, Mit-raTokenFilterer: Mit-raTokenFilterer{contract: contract}}, nil
}

// Mit-raToken is an auto generated Go binding around an Ethereum contract.
type Mit-raToken struct {
	Mit-raTokenCaller     // Read-only binding to the contract
	Mit-raTokenTransactor // Write-only binding to the contract
	Mit-raTokenFilterer   // Log filterer for contract events
}

// Mit-raTokenCaller is an auto generated read-only Go binding around an Ethereum contract.
type Mit-raTokenCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// Mit-raTokenTransactor is an auto generated write-only Go binding around an Ethereum contract.
type Mit-raTokenTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// Mit-raTokenFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type Mit-raTokenFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// Mit-raTokenSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type Mit-raTokenSession struct {
	Contract     *Mit-raToken        // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// Mit-raTokenCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type Mit-raTokenCallerSession struct {
	Contract *Mit-raTokenCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts    // Call options to use throughout this session
}

// Mit-raTokenTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type Mit-raTokenTransactorSession struct {
	Contract     *Mit-raTokenTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts    // Transaction auth options to use throughout this session
}

// Mit-raTokenRaw is an auto generated low-level Go binding around an Ethereum contract.
type Mit-raTokenRaw struct {
	Contract *Mit-raToken // Generic contract binding to access the raw methods on
}

// Mit-raTokenCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type Mit-raTokenCallerRaw struct {
	Contract *Mit-raTokenCaller // Generic read-only contract binding to access the raw methods on
}

// Mit-raTokenTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type Mit-raTokenTransactorRaw struct {
	Contract *Mit-raTokenTransactor // Generic write-only contract binding to access the raw methods on
}

// NewMit-raToken creates a new instance of Mit-raToken, bound to a specific deployed contract.
...
// NewMit-raTokenCaller creates a new read-only instance of Mit-raToken, bound to a specific deployed contract.
...
// NewMit-raTokenTransactor creates a new write-only instance of Mit-raToken, bound to a specific deployed contract.
...
// NewMit-raTokenFilterer creates a new log filterer instance of Mit-raToken, bound to a specific deployed contract.
...
// bindMit-raToken binds a generic wrapper to an already deployed contract.
func bindMit-raToken(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(Mit-raTokenABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_Mit-raToken *Mit-raTokenRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _Mit-raToken.Contract.Mit-raTokenCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Mit-raToken *Mit-raTokenRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Mit-raToken.Contract.Mit-raTokenTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_Mit-raToken *Mit-raTokenRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Mit-raToken.Contract.Mit-raTokenTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_Mit-raToken *Mit-raTokenCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _Mit-raToken.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Mit-raToken *Mit-raTokenTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Mit-raToken.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_Mit-raToken *Mit-raTokenTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Mit-raToken.Contract.contract.Transact(opts, method, params...)
}

// Allowance is a free data retrieval call binding the contract method 0xdd62ed3e.
//
// Solidity: function allowance(_owner address, _spender address) constant returns(uint256)
func (_Mit-raToken *Mit-raTokenCaller) Allowance(opts *bind.CallOpts, _owner common.Address, _spender common.Address) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Mit-raToken.contract.Call(opts, out, "allowance", _owner, _spender)
	return *ret0, err
}
...
//
// Solidity: function allowance(_owner address, _spender address) constant returns(uint256)
func (_Mit-raToken *Mit-raTokenSession) Allowance(_owner common.Address, _spender common.Address) (*big.Int, error) {
	return _Mit-raToken.Contract.Allowance(&_Mit-raToken.CallOpts, _owner, _spender)
}

// Allowance is a free data retrieval call binding the contract method 0xdd62ed3e.
//
// Solidity: function allowance(_owner address, _spender address) constant returns(uint256)
func (_Mit-raToken *Mit-raTokenCallerSession) Allowance(_owner common.Address, _spender common.Address) (*big.Int, error) {
	return _Mit-raToken.Contract.Allowance(&_Mit-raToken.CallOpts, _owner, _spender)
}
...
//
// Solidity: function balanceOf(_owner address) constant returns(uint256)
func (_Mit-raToken *Mit-raTokenCaller) BalanceOf(opts *bind.CallOpts, _owner common.Address) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Mit-raToken.contract.Call(opts, out, "balanceOf", _owner)
	return *ret0, err
}
...
//
// Solidity: function balanceOf(_owner address) constant returns(uint256)
func (_Mit-raToken *Mit-raTokenSession) BalanceOf(_owner common.Address) (*big.Int, error) {
	return _Mit-raToken.Contract.BalanceOf(&_Mit-raToken.CallOpts, _owner)
}

// BalanceOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function balanceOf(_owner address) constant returns(uint256)
func (_Mit-raToken *Mit-raTokenCallerSession) BalanceOf(_owner common.Address) (*big.Int, error) {
	return _Mit-raToken.Contract.BalanceOf(&_Mit-raToken.CallOpts, _owner)
}
...
//
// Solidity: function decimals() constant returns(uint8)
func (_Mit-raToken *Mit-raTokenCaller) Decimals(opts *bind.CallOpts) (uint8, error) {
	var (
		ret0 = new(uint8)
	)
	out := ret0
	err := _Mit-raToken.contract.Call(opts, out, "decimals")
	return *ret0, err
}
...
//
// Solidity: function decimals() constant returns(uint8)
func (_Mit-raToken *Mit-raTokenSession) Decimals() (uint8, error) {
	return _Mit-raToken.Contract.Decimals(&_Mit-raToken.CallOpts)
}

// Decimals is a free data retrieval call binding the contract method 0x313ce567.
//
// Solidity: function decimals() constant returns(uint8)
func (_Mit-raToken *Mit-raTokenCallerSession) Decimals() (uint8, error) {
	return _Mit-raToken.Contract.Decimals(&_Mit-raToken.CallOpts)
}
...
//
// Solidity: function name() constant returns(string)
func (_Mit-raToken *Mit-raTokenCaller) Name(opts *bind.CallOpts) (string, error) {
	var (
		ret0 = new(string)
	)
	out := ret0
	err := _Mit-raToken.contract.Call(opts, out, "name")
	return *ret0, err
}
...
//
// Solidity: function name() constant returns(string)
func (_Mit-raToken *Mit-raTokenSession) Name() (string, error) {
	return _Mit-raToken.Contract.Name(&_Mit-raToken.CallOpts)
}

// Name is a free data retrieval call binding the contract method 0x06fdde03.
//
// Solidity: function name() constant returns(string)
func (_Mit-raToken *Mit-raTokenCallerSession) Name() (string, error) {
	return _Mit-raToken.Contract.Name(&_Mit-raToken.CallOpts)
}
...
//
// Solidity: function owner() constant returns(address)
func (_Mit-raToken *Mit-raTokenCaller) Owner(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Mit-raToken.contract.Call(opts, out, "owner")
	return *ret0, err
}
...
//
// Solidity: function owner() constant returns(address)
func (_Mit-raToken *Mit-raTokenSession) Owner() (common.Address, error) {
	return _Mit-raToken.Contract.Owner(&_Mit-raToken.CallOpts)
}

// Owner is a free data retrieval call binding the contract method 0x8da5cb5b.
//
// Solidity: function owner() constant returns(address)
func (_Mit-raToken *Mit-raTokenCallerSession) Owner() (common.Address, error) {
	return _Mit-raToken.Contract.Owner(&_Mit-raToken.CallOpts)
}
...
//
// Solidity: function paused() constant returns(bool)
func (_Mit-raToken *Mit-raTokenCaller) Paused(opts *bind.CallOpts) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _Mit-raToken.contract.Call(opts, out, "paused")
	return *ret0, err
}
...
//
// Solidity: function paused() constant returns(bool)
func (_Mit-raToken *Mit-raTokenSession) Paused() (bool, error) {
	return _Mit-raToken.Contract.Paused(&_Mit-raToken.CallOpts)
}

// Paused is a free data retrieval call binding the contract method 0x5c975abb.
//
// Solidity: function paused() constant returns(bool)
func (_Mit-raToken *Mit-raTokenCallerSession) Paused() (bool, error) {
	return _Mit-raToken.Contract.Paused(&_Mit-raToken.CallOpts)
}
...
//
// Solidity: function symbol() constant returns(string)
func (_Mit-raToken *Mit-raTokenCaller) Symbol(opts *bind.CallOpts) (string, error) {
	var (
		ret0 = new(string)
	)
	out := ret0
	err := _Mit-raToken.contract.Call(opts, out, "symbol")
	return *ret0, err
}
...
//
// Solidity: function symbol() constant returns(string)
func (_Mit-raToken *Mit-raTokenSession) Symbol() (string, error) {
	return _Mit-raToken.Contract.Symbol(&_Mit-raToken.CallOpts)
}

// Symbol is a free data retrieval call binding the contract method 0x95d89b41.
//
// Solidity: function symbol() constant returns(string)
func (_Mit-raToken *Mit-raTokenCallerSession) Symbol() (string, error) {
	return _Mit-raToken.Contract.Symbol(&_Mit-raToken.CallOpts)
}
...
//
// Solidity: function totalSupply() constant returns(uint256)
func (_Mit-raToken *Mit-raTokenCaller) TotalSupply(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Mit-raToken.contract.Call(opts, out, "totalSupply")
	return *ret0, err
}
...
//
// Solidity: function totalSupply() constant returns(uint256)
func (_Mit-raToken *Mit-raTokenSession) TotalSupply() (*big.Int, error) {
	return _Mit-raToken.Contract.TotalSupply(&_Mit-raToken.CallOpts)
}

// TotalSupply is a free data retrieval call binding the contract method 0x18160ddd.
//
// Solidity: function totalSupply() constant returns(uint256)
func (_Mit-raToken *Mit-raTokenCallerSession) TotalSupply() (*big.Int, error) {
	return _Mit-raToken.Contract.TotalSupply(&_Mit-raToken.CallOpts)
}
...
//
// Solidity: function approve(_spender address, _value uint256) returns(bool)
func (_Mit-raToken *Mit-raTokenTransactor) Approve(opts *bind.TransactOpts, _spender common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.contract.Transact(opts, "approve", _spender, _value)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(_spender address, _value uint256) returns(bool)
func (_Mit-raToken *Mit-raTokenSession) Approve(_spender common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.Approve(&_Mit-raToken.TransactOpts, _spender, _value)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(_spender address, _value uint256) returns(bool)
func (_Mit-raToken *Mit-raTokenTransactorSession) Approve(_spender common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.Approve(&_Mit-raToken.TransactOpts, _spender, _value)
}
...
//
// Solidity: function burn(_value uint256) returns()
func (_Mit-raToken *Mit-raTokenTransactor) Burn(opts *bind.TransactOpts, _value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.contract.Transact(opts, "burn", _value)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(_value uint256) returns()
func (_Mit-raToken *Mit-raTokenSession) Burn(_value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.Burn(&_Mit-raToken.TransactOpts, _value)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(_value uint256) returns()
func (_Mit-raToken *Mit-raTokenTransactorSession) Burn(_value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.Burn(&_Mit-raToken.TransactOpts, _value)
}
...
//
// Solidity: function decreaseApproval(_spender address, _subtractedValue uint256) returns(success bool)
func (_Mit-raToken *Mit-raTokenTransactor) DecreaseApproval(opts *bind.TransactOpts, _spender common.Address, _subtractedValue *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.contract.Transact(opts, "decreaseApproval", _spender, _subtractedValue)
}

// DecreaseApproval is a paid mutator transaction binding the contract method 0x66188463.
//
// Solidity: function decreaseApproval(_spender address, _subtractedValue uint256) returns(success bool)
func (_Mit-raToken *Mit-raTokenSession) DecreaseApproval(_spender common.Address, _subtractedValue *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.DecreaseApproval(&_Mit-raToken.TransactOpts, _spender, _subtractedValue)
}

// DecreaseApproval is a paid mutator transaction binding the contract method 0x66188463.
//
// Solidity: function decreaseApproval(_spender address, _subtractedValue uint256) returns(success bool)
func (_Mit-raToken *Mit-raTokenTransactorSession) DecreaseApproval(_spender common.Address, _subtractedValue *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.DecreaseApproval(&_Mit-raToken.TransactOpts, _spender, _subtractedValue)
}
...
//
// Solidity: function increaseApproval(_spender address, _addedValue uint256) returns(success bool)
func (_Mit-raToken *Mit-raTokenTransactor) IncreaseApproval(opts *bind.TransactOpts, _spender common.Address, _addedValue *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.contract.Transact(opts, "increaseApproval", _spender, _addedValue)
}

// IncreaseApproval is a paid mutator transaction binding the contract method 0xd73dd623.
//
// Solidity: function increaseApproval(_spender address, _addedValue uint256) returns(success bool)
func (_Mit-raToken *Mit-raTokenSession) IncreaseApproval(_spender common.Address, _addedValue *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.IncreaseApproval(&_Mit-raToken.TransactOpts, _spender, _addedValue)
}

// IncreaseApproval is a paid mutator transaction binding the contract method 0xd73dd623.
//
// Solidity: function increaseApproval(_spender address, _addedValue uint256) returns(success bool)
func (_Mit-raToken *Mit-raTokenTransactorSession) IncreaseApproval(_spender common.Address, _addedValue *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.IncreaseApproval(&_Mit-raToken.TransactOpts, _spender, _addedValue)
}
...
//
// Solidity: function pause() returns()
func (_Mit-raToken *Mit-raTokenTransactor) Pause(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Mit-raToken.contract.Transact(opts, "pause")
}

// Pause is a paid mutator transaction binding the contract method 0x8456cb59.
//
// Solidity: function pause() returns()
func (_Mit-raToken *Mit-raTokenSession) Pause() (*types.Transaction, error) {
	return _Mit-raToken.Contract.Pause(&_Mit-raToken.TransactOpts)
}

// Pause is a paid mutator transaction binding the contract method 0x8456cb59.
//
// Solidity: function pause() returns()
func (_Mit-raToken *Mit-raTokenTransactorSession) Pause() (*types.Transaction, error) {
	return _Mit-raToken.Contract.Pause(&_Mit-raToken.TransactOpts)
}
...
//
// Solidity: function transfer(_to address, _value uint256) returns(bool)
func (_Mit-raToken *Mit-raTokenTransactor) Transfer(opts *bind.TransactOpts, _to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.contract.Transact(opts, "transfer", _to, _value)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(_to address, _value uint256) returns(bool)
func (_Mit-raToken *Mit-raTokenSession) Transfer(_to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.Transfer(&_Mit-raToken.TransactOpts, _to, _value)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(_to address, _value uint256) returns(bool)
func (_Mit-raToken *Mit-raTokenTransactorSession) Transfer(_to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.Transfer(&_Mit-raToken.TransactOpts, _to, _value)
}
...
//
// Solidity: function transferFrom(_from address, _to address, _value uint256) returns(bool)
func (_Mit-raToken *Mit-raTokenTransactor) TransferFrom(opts *bind.TransactOpts, _from common.Address, _to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.contract.Transact(opts, "transferFrom", _from, _to, _value)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(_from address, _to address, _value uint256) returns(bool)
func (_Mit-raToken *Mit-raTokenSession) TransferFrom(_from common.Address, _to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.TransferFrom(&_Mit-raToken.TransactOpts, _from, _to, _value)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(_from address, _to address, _value uint256) returns(bool)
func (_Mit-raToken *Mit-raTokenTransactorSession) TransferFrom(_from common.Address, _to common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Mit-raToken.Contract.TransferFrom(&_Mit-raToken.TransactOpts, _from, _to, _value)
}
...
//
// Solidity: function transferOwnership(newOwner address) returns()
func (_Mit-raToken *Mit-raTokenTransactor) TransferOwnership(opts *bind.TransactOpts, newOwner common.Address) (*types.Transaction, error) {
	return _Mit-raToken.contract.Transact(opts, "transferOwnership", newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(newOwner address) returns()
func (_Mit-raToken *Mit-raTokenSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _Mit-raToken.Contract.TransferOwnership(&_Mit-raToken.TransactOpts, newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(newOwner address) returns()
func (_Mit-raToken *Mit-raTokenTransactorSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _Mit-raToken.Contract.TransferOwnership(&_Mit-raToken.TransactOpts, newOwner)
}
...
//
// Solidity: function unpause() returns()
func (_Mit-raToken *Mit-raTokenTransactor) Unpause(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Mit-raToken.contract.Transact(opts, "unpause")
}

// Unpause is a paid mutator transaction binding the contract method 0x3f4ba83a.
//
// Solidity: function unpause() returns()
func (_Mit-raToken *Mit-raTokenSession) Unpause() (*types.Transaction, error) {
	return _Mit-raToken.Contract.Unpause(&_Mit-raToken.TransactOpts)
}

// Unpause is a paid mutator transaction binding the contract method 0x3f4ba83a.
//
// Solidity: function unpause() returns()
func (_Mit-raToken *Mit-raTokenTransactorSession) Unpause() (*types.Transaction, error) {
	return _Mit-raToken.Contract.Unpause(&_Mit-raToken.TransactOpts)
}

// Mit-raTokenApprovalIterator is returned from FilterApproval and is used to iterate over the raw logs and unpacked data for Approval events raised by the Mit-raToken contract.
type Mit-raTokenApprovalIterator struct {
	Event *Mit-raTokenApproval // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Mit-raTokenApprovalIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Mit-raTokenApproval)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Mit-raTokenApprovalIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Mit-raTokenApprovalIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Mit-raTokenApproval represents a Approval event raised by the Mit-raToken contract.
type Mit-raTokenApproval struct {
	Owner   common.Address
	Spender common.Address
	Value   *big.Int
	Raw     types.Log // Blockchain specific contextual infos
...
//
// Solidity: event Approval(owner indexed address, spender indexed address, value uint256)
func (_Mit-raToken *Mit-raTokenFilterer) FilterApproval(opts *bind.FilterOpts, owner []common.Address, spender []common.Address) (*Mit-raTokenApprovalIterator, error) {
	...
	logs, sub, err := _Mit-raToken.contract.FilterLogs(opts, "Approval", ownerRule, spenderRule)
	if err != nil {
		return nil, err
	}
	return &Mit-raTokenApprovalIterator{contract: _Mit-raToken.contract, event: "Approval", logs: logs, sub: sub}, nil
}

// WatchApproval is a free log subscription operation binding the contract event 0x8c5be1e5ebec7d5bd14f71427d1e84f3dd0314c0f7b2291e5b200ac8c7c3b925.
//
// Solidity: event Approval(owner indexed address, spender indexed address, value uint256)
func (_Mit-raToken *Mit-raTokenFilterer) WatchApproval(opts *bind.WatchOpts, sink chan<- *Mit-raTokenApproval, owner []common.Address, spender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Mit-raToken.contract.WatchLogs(opts, "Approval", ownerRule, spenderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Mit-raTokenApproval)
				if err := _Mit-raToken.contract.UnpackLog(event, "Approval", log); err != nil {
					return err
				}
				event.Raw = log
...
// Mit-raTokenBurnIterator is returned from FilterBurn and is used to iterate over the raw logs and unpacked data for Burn events raised by the Mit-raToken contract.
type Mit-raTokenBurnIterator struct {
	Event *Mit-raTokenBurn // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Mit-raTokenBurnIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Mit-raTokenBurnIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Mit-raTokenBurnIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Mit-raTokenBurn represents a Burn event raised by the Mit-raToken contract.
type Mit-raTokenBurn struct {
	Burner common.Address
	Value  *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}
...
//
// Solidity: event Burn(burner indexed address, value uint256)
func (_Mit-raToken *Mit-raTokenFilterer) FilterBurn(opts *bind.FilterOpts, burner []common.Address) (*Mit-raTokenBurnIterator, error) {
	...
	logs, sub, err := _Mit-raToken.contract.FilterLogs(opts, "Burn", burnerRule)
	if err != nil {
		return nil, err
	}
	return &Mit-raTokenBurnIterator{contract: _Mit-raToken.contract, event: "Burn", logs: logs, sub: sub}, nil
}

// WatchBurn is a free log subscription operation binding the contract event 0xcc16f5dbb4873280815c1ee09dbd06736cffcc184412cf7a71a0fdb75d397ca5.
//
// Solidity: event Burn(burner indexed address, value uint256)
func (_Mit-raToken *Mit-raTokenFilterer) WatchBurn(opts *bind.WatchOpts, sink chan<- *Mit-raTokenBurn, burner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Mit-raToken.contract.WatchLogs(opts, "Burn", burnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Mit-raTokenBurn)
				if err := _Mit-raToken.contract.UnpackLog(event, "Burn", log); err != nil {
					return err
				}
				event.Raw = log
...
// Mit-raTokenOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the Mit-raToken contract.
type Mit-raTokenOwnershipTransferredIterator struct {
	Event *Mit-raTokenOwnershipTransferred // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Mit-raTokenOwnershipTransferredIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Mit-raTokenOwnershipTransferred)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Mit-raTokenOwnershipTransferredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Mit-raTokenOwnershipTransferredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Mit-raTokenOwnershipTransferred represents a OwnershipTransferred event raised by the Mit-raToken contract.
type Mit-raTokenOwnershipTransferred struct {
	PreviousOwner common.Address
	NewOwner      common.Address
	Raw           types.Log // Blockchain specific contextual infos
}
...
//
// Solidity: event OwnershipTransferred(previousOwner indexed address, newOwner indexed address)
func (_Mit-raToken *Mit-raTokenFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*Mit-raTokenOwnershipTransferredIterator, error) {
	...
	logs, sub, err := _Mit-raToken.contract.FilterLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &Mit-raTokenOwnershipTransferredIterator{contract: _Mit-raToken.contract, event: "OwnershipTransferred", logs: logs, sub: sub}, nil
}

// WatchOwnershipTransferred is a free log subscription operation binding the contract event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
// Solidity: event OwnershipTransferred(previousOwner indexed address, newOwner indexed address)
func (_Mit-raToken *Mit-raTokenFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *Mit-raTokenOwnershipTransferred, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Mit-raToken.contract.WatchLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Mit-raTokenOwnershipTransferred)
				if err := _Mit-raToken.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
// Mit-raTokenPauseIterator is returned from FilterPause and is used to iterate over the raw logs and unpacked data for Pause events raised by the Mit-raToken contract.
type Mit-raTokenPauseIterator struct {
	Event *Mit-raTokenPause // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Mit-raTokenPauseIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Mit-raTokenPauseIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Mit-raTokenPauseIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Mit-raTokenPause represents a Pause event raised by the Mit-raToken contract.
type Mit-raTokenPause struct {
	Raw types.Log // Blockchain specific contextual infos
}
...
//
// Solidity: event Pause()
func (_Mit-raToken *Mit-raTokenFilterer) FilterPause(opts *bind.FilterOpts) (*Mit-raTokenPauseIterator, error) {

	logs, sub, err := _Mit-raToken.contract.FilterLogs(opts, "Pause")
	if err != nil {
		return nil, err
	}
	return &Mit-raTokenPauseIterator{contract: _Mit-raToken.contract, event: "Pause", logs: logs, sub: sub}, nil
}

// WatchPause is a free log subscription operation binding the contract event 0x6985a02210a168e66602d3235cb6db0e70f92b3ba4d376a33c0f3d9434bff625.
//
// Solidity: event Pause()
func (_Mit-raToken *Mit-raTokenFilterer) WatchPause(opts *bind.WatchOpts, sink chan<- *Mit-raTokenPause) (event.Subscription, error) {

	logs, sub, err := _Mit-raToken.contract.WatchLogs(opts, "Pause")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Mit-raTokenPause)
				if err := _Mit-raToken.contract.UnpackLog(event, "Pause", log); err != nil {
					return err
				}
				event.Raw = log
...
// Mit-raTokenTransferIterator is returned from FilterTransfer and is used to iterate over the raw logs and unpacked data for Transfer events raised by the Mit-raToken contract.
type Mit-raTokenTransferIterator struct {
	Event *Mit-raTokenTransfer // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Mit-raTokenTransferIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Mit-raTokenTransfer)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Mit-raTokenTransferIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Mit-raTokenTransferIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Mit-raTokenTransfer represents a Transfer event raised by the Mit-raToken contract.
type Mit-raTokenTransfer struct {
	From  common.Address
	To    common.Address
	Value *big.Int
	Raw   types.Log // Blockchain specific contextual infos
...
//
// Solidity: event Transfer(from indexed address, to indexed address, value uint256)
func (_Mit-raToken *Mit-raTokenFilterer) FilterTransfer(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*Mit-raTokenTransferIterator, error) {
	...
	logs, sub, err := _Mit-raToken.contract.FilterLogs(opts, "Transfer", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &Mit-raTokenTransferIterator{contract: _Mit-raToken.contract, event: "Transfer", logs: logs, sub: sub}, nil
}

// WatchTransfer is a free log subscription operation binding the contract event 0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef.
//
// Solidity: event Transfer(from indexed address, to indexed address, value uint256)
func (_Mit-raToken *Mit-raTokenFilterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *Mit-raTokenTransfer, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Mit-raToken.contract.WatchLogs(opts, "Transfer", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Mit-raTokenTransfer)
				if err := _Mit-raToken.contract.UnpackLog(event, "Transfer", log); err != nil {
					return err
				}
				event.Raw = log
...
// Mit-raTokenUnpauseIterator is returned from FilterUnpause and is used to iterate over the raw logs and unpacked data for Unpause events raised by the Mit-raToken contract.
type Mit-raTokenUnpauseIterator struct {
	Event *Mit-raTokenUnpause // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Mit-raTokenUnpauseIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Mit-raTokenUnpause)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Mit-raTokenUnpauseIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Mit-raTokenUnpauseIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Mit-raTokenUnpause represents a Unpause event raised by the Mit-raToken contract.
type Mit-raTokenUnpause struct {
	Raw types.Log // Blockchain specific contextual infos
}
...
//
// Solidity: event Unpause()
func (_Mit-raToken *Mit-raTokenFilterer) FilterUnpause(opts *bind.FilterOpts) (*Mit-raTokenUnpauseIterator, error) {

	logs, sub, err := _Mit-raToken.contract.FilterLogs(opts, "Unpause")
	if err != nil {
		return nil, err
	}
	return &Mit-raTokenUnpauseIterator{contract: _Mit-raToken.contract, event: "Unpause", logs: logs, sub: sub}, nil
}

// WatchUnpause is a free log subscription operation binding the contract event 0x7805862f689e2f13df9f062ff482ad3ad112aca9e0847911ed832e158c525b33.
//
// Solidity: event Unpause()
func (_Mit-raToken *Mit-raTokenFilterer) WatchUnpause(opts *bind.WatchOpts, sink chan<- *Mit-raTokenUnpause) (event.Subscription, error) {

	logs, sub, err := _Mit-raToken.contract.WatchLogs(opts, "Unpause")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Mit-raTokenUnpause)
				if err := _Mit-raToken.contract.UnpackLog(event, "Unpause", log); err != nil {
					return err
				}
				event.Raw = log
